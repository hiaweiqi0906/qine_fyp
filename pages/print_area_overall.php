        ...
        <table id="example" class="table table-striped table-bordered" style="width:100%">
            <thead>
                ...
                <tr>
                    ...
                    <td><input type="text" id="_score_1" name="score_1" autocomplete="off" onchange="calcOverall1()"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="_score_2" name="score_2" autocomplete="off" onchange="calcOverall2()"
                            required value="<?php if (isset($akredasi_penuh_bidang)) {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="_score_3" name="score_3" autocomplete="off" onchange="calcOverall3()"
                            required value="<?php if (isset($akredasi_penuh_bidang)) {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="_score_4" name="score_4" autocomplete="off" onchange="calcOverall4()"
                            required value="<?php if (isset($akredasi_penuh_bidang)) {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="_score_5" name="score_5" autocomplete="off" onchange="calcOverall5()"
                            required value="<?php if (isset($akredasi_penuh_bidang)) {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="_score_6" name="score_6" autocomplete="off" onchange="calcOverall6()"
                            required value="<?php if (isset($akredasi_penuh_bidang)) {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="_score_7" name="score_7" autocomplete="off" onchange="calcOverall7()"
                            required value="<?php if (isset($akredasi_penuh_bidang)) {
